...
if __name__ == "__main__":
    bm_size = 2000  # band matrix size
    num_sensitive = 5  # number of sensitive items
    p_degree = 4  # the degree of privacy
    alpha = 3
    ...
    print(f"Privacy-degree: {cahd.p_degree}, Time required: {end_time}\n")
    ...
    print(f"Degree of privacy: {str(cahd.p_degree)}\nNumber of sensitive items: {str(num_sensitive)}\n"
          f"KL_Divergence: {str(KL_Divergence)}\n")

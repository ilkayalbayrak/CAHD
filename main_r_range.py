...
if __name__ == "__main__":
    ...
    for r in r_list:
        ...
        for QID_select in QID_select_list:
            ...
            print(f"\n{'-' * 20}\nKL_Divergence Total: {KLD_value}, r: {r} Privacy degree: {p_degree},"
    ...
    df_to_plot.to_csv(f"./Data_to_plot/Rasd_TEST1_BMS1_seed_42_bm{bm_size}_p{p_degree}_r_range.csv", index=False)
